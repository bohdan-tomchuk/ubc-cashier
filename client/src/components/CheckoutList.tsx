...
export default function CheckoutList({ items, onCheckout }: CheckoutListProps) {
  ...
  return (
    <>
      <Card className={`flex-col w-[90vw] max-w-[400px] max-h-[90vh] fixed m-auto lg:m-0 top-[50%] left-[50%] lg:top-20 lg:left-0 translate-y-[-50%] translate-x-[-50%] lg:translate-x-[0%] lg:translate-y-[0%] lg:sticky z-20 lg:z-0 ${isModal ? modalStyleOpen : 'flex'}`}>
